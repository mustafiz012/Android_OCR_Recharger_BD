 ...
 */
package musta.kuet.shahrukhkhanerjonne.languages;
...
import musta.kuet.shahrukhkhanerjonne.CaptureActivity;
import musta.kuet.shahrukhkhanerjonne.R;
...
public final class TranslateAsyncTask extends AsyncTask<String, String, Boolean> {
  ...
  protected synchronized void onPostExecute(Boolean result) {
    ...
    if (result) {
      ...
      textView.setText("Musta: "+translatedText);
      Log.i("result",""+translatedText);
