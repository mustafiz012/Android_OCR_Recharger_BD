...
import musta.kuet.shahrukhkhanerjonne.camera.CameraManager;
import musta.kuet.shahrukhkhanerjonne.camera.ShutterButton;
import musta.kuet.shahrukhkhanerjonne.languages.LanguageCodeHelper;
import musta.kuet.shahrukhkhanerjonne.languages.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  void onShutterButtonPressContinuous() {
    ...
    if (lastResult != null) {
      //Toast.makeText(getApplicationContext(), "Musta"+lastResult, Toast.LENGTH_SHORT).show();
      //Log.i("Mustafiz",""+lastResult);
  ...
  private boolean setSourceLanguage(String languageCode) {
    ...
    //Toast.makeText(getApplicationContext(), "Musta"+sourceLanguageCodeOcr, Toast.LENGTH_SHORT).show();
    ...
    //Log.i("Musta:",""+sourceLanguageCodeOcr);
    return true;
  }
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    // Display the recognized text     ////result of ocr is here
    TextView sourceLanguageTextView = (TextView) findViewById(R.id.source_language_text_view);
    sourceLanguageTextView.setText(sourceLanguageReadable);
    TextView ocrResultTextView = (TextView) findViewById(R.id.ocr_result_text_view);
    //Integer result = Integer.parseInt(ocrResult.getText().toString());
    String resultStr = ocrResult.getText().toString();
    //Toast.makeText(getApplicationContext(), "Mustafiz"+result, Toast.LENGTH_SHORT).show();
    //Log.i("Mustafizzz",""+resultStr);
    if (resultStr!=null){
      Intent intent = new Intent(CaptureActivity.this, MainScreenAfterResult.class);
      //intent.putExtra("result", result);
      intent.putExtra("resu", resultStr);
      startActivity(intent);
      finish();
    }
